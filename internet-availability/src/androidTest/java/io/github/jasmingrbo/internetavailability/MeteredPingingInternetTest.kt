...
internal class MeteredPingingInternetTest : InternetTest() {
    override fun provideInternet() = Internet.getInstance(
        scope = scope,
        pingOnNonMeteredNetworks = false,
        context = context
    )
    ...
    @Test
    fun given_mobile_data_when_availability_collected_and_internet_disabled_then_internet_unavailable_and_pinging() {
        // Given internet instance
        enableMobileData()
    ...
    @Test
    fun given_wifi_when_availability_collected_and_internet_disabled_then_internet_available_and_no_pinging() {
        // Given internet instance
        enableWifi()
    ...
    @Test
    fun given_mobile_data_when_internet_toggled_then_correctly_emitted_availability_and_pinging() {
        // Given internet instance
        enableMobileData()
